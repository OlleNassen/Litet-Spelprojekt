...
void Text::RenderText(std::string text, GLfloat x, GLfloat y, GLfloat scale, glm::vec3 color, const glm::mat4& projection)
{
...
void Text::RenderHighscore(std::string text, GLfloat x, GLfloat y, GLfloat scale, glm::vec3 color, const glm::mat4 & projection)
{
	// Activate corresponding render state	
	shader->use();
	this->shader->setMatrix4fv(projection, "projection");
